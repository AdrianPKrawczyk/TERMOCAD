...
- [x] Instalacja bazowych zależności (Vite, React, Tailwind, Zustand).
- [x] Utworzenie pliku `memory.md`.
- [x] Opracowanie Architektury Danych i wymagań dla XML.

## 📝 Zadania do zrobienia (Backlog)
- [ ] **Krok 1: Szkielet UI (Layout)** - Zbudowanie bazowego układu z użyciem Tailwind CSS (Lewy Sidebar dla struktury kategorii, Górna belka z przyciskami "Zmienne Globalne" i "Eksport XML", Główny obszar roboczy).
